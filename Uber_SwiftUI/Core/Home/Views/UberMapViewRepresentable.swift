...
extension UberMapViewRepresentable {
  class MapCoordinator: NSObject, MKMapViewDelegate {
    ...
    // MARK: - MKMapViewDelegate Methods - After setting Polyline from configurePolyline need the delegate method to actual show the polyline on Map , i.e., rendererFor
    ...
    // MARK: - Clear Map View after back button tapped
